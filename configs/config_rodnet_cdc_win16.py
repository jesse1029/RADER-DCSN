dataset_cfg = dict(
    ...
    base_root="/media/jess/ec60f916-4bd2-4bf2-b75d-2c2fe8508c47/ROD2021/RODNet",
    data_root="/media/jess/ec60f916-4bd2-4bf2-b75d-2c2fe8508c47/ROD2021/RODNet",
    anno_root="/media/jess/ec60f916-4bd2-4bf2-b75d-2c2fe8508c47/ROD2021/RODNet/TRAIN_RAD_H_ANNO",
    anno_ext='.txt',
    train=dict(
        subdir='train',
