...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='/nvme2/ROD2021/configs/hgwl2.py', help='choose rodnet model configurations')
    parser.add_argument('--data_dir', type=str, default='./data/', help='directory to the prepared data')
    parser.add_argument('--checkpoint', type=str, default='/nvme2/ROD2021/checkpoints/ours2-20210404-020910/epoch_01_final.pkl',help='path to the saved trained model')
